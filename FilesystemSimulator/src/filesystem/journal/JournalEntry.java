 ...
 *
 * Cada operacion sobre el sistema de archivos genera una entrada
 * que se registra como PENDING antes de ejecutarse y se marca
 * como CONFIRMED tras completarse exitosamente.
 *
 * En caso de fallo, las entradas PENDING se marcan ROLLED_BACK.
...
public class JournalEntry {
    ...
    /**
     * Datos anteriores al cambio, usados para el UNDO.
     * Puede ser el contenido anterior, nombre anterior, etc.
     */
    ...
    public boolean isConfirmed()  { return status == JournalStatus.CONFIRMED; }
    public boolean isRolledBack() { return status == JournalStatus.ROLLED_BACK; }
