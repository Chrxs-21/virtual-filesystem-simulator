...
/**
 * Sistema de archivos simulado. Coordina la asignación de bloques en disco, la
 * estructura de directorios y todas las operaciones sobre archivos.
 *
 * Usa DiskBitmap propio y arreglo DiskBlock[] como disco simulado. No usa
...
public class FileSystem {
    ...
    /**
     * Inicializa el sistema de archivos con el disco vacío y el directorio raíz
     * creado.
     */
    public FileSystem() {
    ...
    /**
     * Crea un nuevo archivo en el directorio dado y le asigna los bloques
     * necesarios en el disco mediante asignación encadenada.
     *
    ...
    /**
     * Lee y reconstruye el contenido completo de un archivo recorriendo su
     * cadena de bloques en el disco.
     *
    ...
    /**
     * Elimina un archivo del directorio y libera todos sus bloques en el disco
     * recorriendo la cadena completa.
     *
     * @param fileName Nombre del archivo a eliminar.
     * @param directory Directorio donde está el archivo.
     * @throws IllegalArgumentException si el archivo no existe.
     * @throws IllegalStateException si el archivo es de solo lectura y el modo
     * actual es USUARIO.
     */
     ...
     * @throws IllegalArgumentException si ya existe un directorio con ese
     * nombre.
    ...
    /**
     * Elimina un directorio y todo su contenido de forma recursiva. Libera
     * todos los bloques de disco de los archivos contenidos.
     *
    ...
    /**
     * Método auxiliar que elimina recursivamente el contenido de un directorio:
     * primero sus subdirectorios, luego sus archivos.
     *
    ...
    /**
     * Libera todos los bloques de disco ocupados por un archivo. Método interno
     * reutilizado por deleteFile y deleteDirectoryRecursive.
     *
...
// ─── OPERACIONES CRUD ADICIONALES ───────────────────────────────────────
     ...
     * @throws IllegalArgumentException si el archivo no existe, o si ya existe
     * uno con el nuevo nombre.
     * @throws IllegalStateException si el archivo es de solo lectura y el modo
     * es USUARIO.
     */
    ...
    /**
     * Actualiza el nombre del propietario en todos los bloques de un archivo
     * después de renombrarlo.
     *
    ...
    /**
     * Actualiza el contenido de un archivo existente. Libera los bloques
     * antiguos y asigna bloques nuevos con el contenido actualizado.
     *
     * @param fileName Nombre del archivo a actualizar.
     * @param newContent Nuevo contenido del archivo.
     * @param directory Directorio que contiene el archivo.
     * @throws IllegalArgumentException si el archivo no existe.
     * @throws IllegalStateException si es de solo lectura y modo USUARIO, o si
    ...
    /**
     * Busca un archivo por nombre dentro de un directorio y todos sus
    ...
    // ─── UTILIDADES ─────────────────────────────────────────────────────────
    /**
     * Calcula cuántos bloques necesita un contenido dado. Mínimo 1 bloque
     * aunque el contenido esté vacío.
     *
     * @param content Contenido del archivo.
    ...
    public void setCurrentMode(UserMode mode) {
