...
/**
 * Representa un bloque físico del disco simulado.
 * Cada archivo es una cadena de estos bloques enlazados.
 * El campo 'nextBlock' apunta al índice del siguiente bloque
 * del mismo archivo. -1 indica que es el último bloque.
 */
public class DiskBlock {
    ...
    /**
     * Índice del siguiente bloque del mismo archivo.
     * -1 si es el último bloque de la cadena.
     */
    ...
    public boolean isFree()    { return ownerFile == null; }

    // ─── SETTERS ────────────────────────────────────────────────────────────

    public void setNextBlock(int nextBlock)   { this.nextBlock = nextBlock; }
    public void setOwnerFile(String owner)    { this.ownerFile = owner; }
