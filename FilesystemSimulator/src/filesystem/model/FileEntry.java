...
/**
 * Representa un archivo dentro del sistema de archivos simulado. No almacena
 * los bloques directamente, sino el índice del primer bloque de su cadena. El
 * resto se recorre desde el disco.
 */
public class FileEntry {
    ...
    /**
     * Índice del primer bloque de este archivo en el disco. -1 si el archivo
     * está vacío o no tiene bloques asignados.
     */
