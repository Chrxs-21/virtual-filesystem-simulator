...
/**
 * Representa un directorio dentro del sistema de archivos. Contiene
 * subdirectorios y archivos usando listas enlazadas propias. No usa
 * java.util.ArrayList ni ninguna colección del JCF.
 */
public class DirectoryEntry {
    ...
    /**
     * Subdirectorios contenidos en este directorio. Usa LinkedList propia, no
     * ArrayList.
     */
    private final LinkedList<DirectoryEntry> subDirectories;

    /**
     * Archivos contenidos en este directorio. Usa LinkedList propia, no
     * ArrayList.
     */
