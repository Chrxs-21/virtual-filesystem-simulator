 ...
 *
 * Implementa el protocolo de locks compartido/exclusivo: - Lock compartido:
 * multiples lectores simultaneos permitidos. - Lock exclusivo: un solo
 * escritor, bloquea a todos los demas.
 *
 * Los procesos bloqueados se encolan en una lista de espera usando LinkedList
 * propia. No usa java.util.* de colecciones.
 */
public class FileLock {
    ...
    /**
     * Cola de procesos esperando acceso al archivo. Usa LinkedList propia, no
     * ArrayList ni Queue.
     */
    ...
    /**
     * Crea un lock para el archivo especificado. Inicialmente sin ningun lock
     * activo.
     *
    ...
    // ─── ADQUIRIR LOCK ──────────────────────────────────────────────────────
    /**
     * Intenta adquirir un lock compartido (lectura) para un proceso. Se otorga
     * si no hay un lock exclusivo activo. Si no se puede otorgar, el proceso
     * queda en cola de espera.
     *
    ...
    /**
     * Intenta adquirir un lock exclusivo (escritura) para un proceso. Se otorga
     * solo si no hay ningun lock activo. Si no se puede otorgar, el proceso
     * queda en cola de espera.
     *
     * @param processName Nombre del proceso solicitante.
     * @return true si el lock fue otorgado, false si quedo bloqueado.
    ...
    // ─── LIBERAR LOCK ───────────────────────────────────────────────────────
    /**
     * Libera el lock compartido de un lector. Si era el ultimo lector, intenta
    ...
    /**
     * Libera el lock exclusivo del escritor activo. Intenta despertar el
     * siguiente proceso en espera.
     *
     * @param processName Nombre del proceso que libera el lock.
    ...
    // ─── DESPERTAR PROCESOS EN ESPERA ───────────────────────────────────────
    /**
     * Intenta otorgar el lock al siguiente proceso en la cola de espera. Si el
     * siguiente pide compartido, despierta a todos los lectores consecutivos en
     * la cola.
     */
    ...
    public boolean isLocked() {
        return currentLockType != LockType.NONE;
    }
