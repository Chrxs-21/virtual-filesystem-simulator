...
/**
 * Representa una solicitud de E/S hacia el disco simulado. Contiene la posición
 * del cilindro que necesita el proceso, el tipo de operación y el estado actual
 * de la solicitud.
 *
...
public class IORequest {
    ...
    public int getCylinderPosition() {
